...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  File? _imageFile;           // local file from picker
  ...
  Future<void> _saveProfile() async {
    ...
    // ✅ Pass image as a file path — NOT base64
    final success = await profileProvider.updateUserProfile(
      profileData,
      profileImagePath: _imageFile?.path, // null = no photo change
    );
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          const Icon(Icons.cake, color: Primary),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          border: Border.all(color: Colors.grey[300]!)),
                      child: Row(children: [
                        const Icon(Icons.family_restroom, color: Primary),
                        const SizedBox(width: 12),
                        const Expanded(
                          child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
  ...
  // Show newly picked file first, then fall back to cached profile image
